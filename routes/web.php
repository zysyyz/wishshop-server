...
$router->get('stores/{store_id}/products/{product_id}/reviews'  , 'ReviewController@index');
...
$router->post('stores/{store_id}/orders/{number}/items'         , 'OrderLineItemController@store');
